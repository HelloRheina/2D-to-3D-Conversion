...
void run_iopaint(const std::string& image_path, const std::string& mask_path, const std::string& output_path) {
    std::string command =
        "conda run -n gsAvatar iopaint run --model=lama --device=cuda --image=" + image_path + " --mask=" + mask_path + " --output=" + output_path;
...
int main() {
    ...
    std::string orig_image         = "/media/hjh/DISK/workplace/2D_to_3D/FHY_2D3D/input/hjh_mask/04/depth.png";
    std::string disp_image         = "/media/hjh/DISK/workplace/2D_to_3D/FHY_2D3D/input/hjh_mask/04/depth.png";
    std::string orig_image_inpaint = "/media/hjh/DISK/workplace/2D_to_3D/FHY_2D3D/input/lama_output/05/image/inpainted_with_mask.png";
    std::string disp_image_inpaint = "/media/hjh/DISK/workplace/2D_to_3D/FHY_2D3D/input/lama_output/05/depth/inpainted_with_mask.png";
    std::string save_path          = "/media/hjh/DISK/workplace/2D_to_3D/FHY_2D3D/input/hjh_mask/04/lama/depth";
    std::string img_id             = "1";
    if (save_path.back() != '/') {
        save_path += '/';
    }
